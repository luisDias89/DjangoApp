...
deve ser inferior ao soft switch se ativado nas configurações GRBL de modo a não haver
um bloquei da maquina em RUNTIME.
No dicionario angulo devemos inserir qual o angulo minimo e maximo de cada eixo de modo 
a que o algoritmo consiga calcular qual o ponto 0 em milimetros , após o reset da máquina 
o software envia os motores para o angulo 0.
