...
var txt_inclina=document.getElementById('id_inclina');                      // Texto por cima da imagem
var rangeTorce=document.getElementById('id_inclinador');               // Recebe o objeto range slide do inclinador
var RoloTorce=document.getElementById('RoloTorce');               // Recebe o objeto range slide do inclinador
var txt_rotacao=document.getElementById('id_rotacao');
...
setInterval(funcIterador, 200);                                                // Intrevalo de 200 ms entre cada ciclo
let bufferValorY=0;
let bufferValorX=0;
...
var Joy1 = new JoyStick('joy1Div', {}, function (stickData) {
    //
    joy1InputPosX = stickData.xPosition;
    

    joy1InputPosY = stickData.yPosition;
    joy1Direcao = stickData.cardinalDirection;
...
// e apresenta uma mensagem se não for um numero de 0 a 100
    ...
    {   
        ...
        if(validaNumber(newValor,3))
        {
            newValor=Math.abs(newValor);                                            // Elimina valores negativos
            newValor > 100 ? newValor=100 : newValor=newValor                       // Se for maior que 100 define 100
            txt_rolo_dir_subir.innerHTML = newValor.toString()+ "%";
        }
        else{ console.log("Não é um numero ou tem mais de 3 algarismos: " + newValor);}
    }
//========================================================
