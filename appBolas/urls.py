...
urlpatterns = [
    ...
    path("modoauto", views.modoauto, name="modoauto"),                          # Quando vem um pedido de 'modoauto' browser retorna a funcao modoauto
    path('vel_mot_esq_aum', views.vel_mot_esq_aum,name='vel_mot_esq_aum'),      # vel_mot_esq_aum -> retorna a funcao vel_mot_esq_aum
    path('contato', contato, name='contato'),                                   # contato -> retorna a funcao homepage
